...
namespace SignalRNotification.Hubs
{
    public class NotificationHub : Hub
    {
        ...
        {
            var hubConnections = dbContext.HubConnections.Join(dbContext.Users, c => c.Username, o => o.Username, (c, o) => new { c.Username, c.ConnectionId, o.Dept }).Where(o => o.Dept == group).ToList();
            foreach (var hubConnection in hubConnections)
            {
